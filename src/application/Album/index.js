...
import { HEADER_HEIGHT } from '../../api/data';
import { getSingerName, getCount, isEmptyObject } from '../../utils/index';
// actions
const { getAlbumList, changeLoading } = actions;
              ...
              return (
                <li key={index}>
                  ...
                  <div className="info">
                    <span>{item.name}</span>
                    <span>
                      { getSingerName(item.ar) } - { item.al.name }
                    </span>
                  </div>
                </li>
              )
